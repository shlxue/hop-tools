...
public final class LData {
  ...
  private static int fixOffset(Control control) {
    return 0;
  }
  ...
  //  public static FormData fillAll(Control top, int hHint) {
  //    return form(SWT.DEFAULT, hHint).left(0).top(top).right(100).bottom(30).get();
  //  }
