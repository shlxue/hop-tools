...
public class ActionExampleDialog extends ActionDialog {
  private final Text wName;

  private final ActionExample action;
  private final boolean changed;

  public ActionExampleDialog(
      Shell parent, ActionExample action, WorkflowMeta workflowMeta, IVariables variables) {
