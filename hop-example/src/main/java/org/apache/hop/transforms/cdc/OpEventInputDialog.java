  ...
  public OpEventInputDialog(
    ...
    Button wButton =
        Widgets.button(SWT.PUSH)
            ...
            .onSelect(Listeners::onSelectSchema)
            .create(shell);
    wSchema =
    ...
    Widgets.label(SWT.RIGHT)
        ...
        .create(shell);
    SwtHelper.bind(Type.JdbcSchema, wButton, wSchema.getTextWidget(), this::getSchema);

    wButton =
        Widgets.button(SWT.PUSH)
            .text(BaseMessages.getString(PKG, "System.Button.Browse"))
            .layoutData(LData.toRight(wSchema))
            .onSelect(Listeners::onSelectTable)
            .create(shell);
    wTable =
        Widgets.ofVar(new TextVar(var, shell, style), TextVar::getTextWidget)
            .message("Table name")
    ...
    Widgets.label(SWT.RIGHT)
        ...
        .create(shell);
    SwtHelper.bind(Type.JdbcTable, wButton, wTable.getTextWidget(), this::getTable);
    HopHelper.bind(
        var,
        pipelineMeta,
        loggingObject,
